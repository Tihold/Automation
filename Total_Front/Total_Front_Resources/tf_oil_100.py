...
start_time_oil_100 = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test04_oil_100(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_oil_100,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test04_oil_bug.png')
        ...
        # Running locator script for searching "Plus" buttons and clicking the button with oil.
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_oil_100,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test04_oil_bug.png', 1)
        ...
        run_time = end_time - start_time_oil_100
        ...
        if resources_delta_int == 100:
            f2.write("***************************************************************" + '\n'
                     ...
                     + 'Oil before: ' + str(resources_first_int) + '\n'
                     + 'Oil after: ' + str(resources_second_int) + '\n'
