...
start_time_preserves_50k = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test01_preserves_50k(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_preserves_50k,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test01_preserves_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_preserves_50k,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test01_preserves_bug.png', 0)
        ...
        run_time = end_time - start_time_preserves_50k
