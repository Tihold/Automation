...
start_time_materials_100 = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test04_materials_100(self):
        ...
        # Recording the quantity of materials
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_materials_100,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test04_materials_bug.png')
        ...
        # Running locator script for searching "Plus" buttons and clicking the button with materials.
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_materials_100,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test04_materials_bug.png', 2)
        self.plus_coins.find_xy_and_click()

        # Switching to next page
        self.snext_page = ImageClicker('C:\Automation\Screens\Total_Front\TF_Resources\snext_page.png', 50,
                                       error_materials_100,
                                       '\Automation\Reports\Total_Front\RESOURCES\Test04_materials_bug.png')
        self.snext_page.founder_and_clicker()

        # Clicking to "10 Gold" button
        self.s10_gold = ImageClicker('C:\Automation\Screens\Total_Front\TF_Resources\s10_gold.png', 50,
                                      error_materials_100,
                                      '\Automation\Reports\Total_Front\RESOURCES\Test04_materials_bug.png')
        self.s10_gold.founder_and_clicker()
        ...
        run_time = end_time - start_time_materials_100
        run_time1 = str(run_time)
        run_time2 = (run_time1[:-7])
        tf = r'C:\Total_Front_resources_Log.txt'
        f2 = open(tf, 'a')
        if resources_delta_int == 100:
            f2.write("***************************************************************" + '\n'
                     + 'TEST 4 completed in: ' + str(timenow2) + '\n'
                     + 'Materials before: ' + str(resources_first_int) + '\n'
                     + 'Materials after: ' + str(resources_second_int) + '\n'
