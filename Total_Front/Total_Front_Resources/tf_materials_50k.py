...
start_time_materials_50k = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test01_materials_50k(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_materials_50k,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test01_materials_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_materials_50k,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test01_materials_bug.png', 2)
        self.plus_coins.find_xy_and_click()

        # Clicking to "400 Gold" button
        self.s400_gold = ImageClicker('C:\Automation\Screens\Total_Front\TF_Resources\s400_gold.png', 50,
                                      error_materials_50k,
                                      '\Automation\Reports\Total_Front\RESOURCES\Test01_materials_bug.png')
        self.s400_gold.founder_and_clicker()
