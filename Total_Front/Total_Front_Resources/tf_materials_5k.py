...
start_time_materials_5k = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test02_materials_5k(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_materials_5k,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test02_materials_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_materials_5k,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test02_materials_bug.png', 2)
        self.plus_coins.find_xy_and_click()

        # Clicking to "150 Gold" button
        self.s150_gold = ImageClicker('C:\Automation\Screens\Total_Front\TF_Resources\s150_gold.png', 50,
                                      error_materials_5k,
                                      '\Automation\Reports\Total_Front\RESOURCES\Test02_materials_bug.png')
        self.s150_gold.founder_and_clicker()
        ...
        run_time = end_time - start_time_materials_5k
        run_time1 = str(run_time)
        run_time2 = (run_time1[:-7])
        tf = r'C:\Total_Front_resources_Log.txt'
        f2 = open(tf, 'a')
        if resources_delta_int == 5000:
            f2.write("***************************************************************" + '\n'
                     + 'TEST 2 completed in: ' + str(timenow2) + '\n'
