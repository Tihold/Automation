...
start_time_steel_100 = datetime.now()
...
class Resources(unittest.TestCase):
    ...
    def test04_steel_100(self):
        ...
        # Recording the quantity of steel
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_steel_100,
                                  '\Automation\Reports\Total_Front\RESOURCES\Test04_steel_bug.png')
        ...
        # Running locator script for searching "Plus" buttons and clicking the button with steel.
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Total_Front\TF_Resources\splus_button.png', 50,
                                         error_steel_100,
                                         '\Automation\Reports\Total_Front\RESOURCES\Test04_steel_bug.png', 3)
        ...
        run_time = end_time - start_time_steel_100
        ...
        if resources_delta_int == 100:
            f2.write("***************************************************************" + '\n'
                     ...
                     + 'Steel before: ' + str(resources_first_int) + '\n'
                     + 'Steel after: ' + str(resources_second_int) + '\n'
