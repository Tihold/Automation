...
class VIP(unittest.TestCase):
    def setUp(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_vip30, '\Automation\Reports\Total_Front\VIP\Test03_bug.png')
    ...
    def test03_vip30days(self):
        ...
        # Clicking to image of 25 dollars
        self.s2dollar = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_VIP\s25dollars.png', 50,
                                     error_vip30, '\Automation\Reports\Total_Front\VIP\Test03_bug.png')
        ...
        run_time = end_time - start_time30
        run_time1 = str(run_time)
        run_time2 = (run_time1[:-7])
        tf = r'C:\Total_Front_VIP_Log.txt'
        f2 = open(tf, 'a')
        f2.write("***************************************************************" + '\n'
                 + 'TEST 3 (VIP for 30 days) completed in: ' + str(timenow2) + '\n'
