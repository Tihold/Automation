...
class VIP(unittest.TestCase):
    ...
    def test02_1000gold(self):
        ...
        # Clicking to image of 50 dollars
        self.imagedollars = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_Gold\sgold50.png', 50,
                                         error_gold1000, '\Automation\Reports\Total_Front\GOLD\Test02_bug.png')
        ...
        run_time = end_time - start_time1000
