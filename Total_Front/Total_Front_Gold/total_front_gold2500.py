...
class Gold(unittest.TestCase):
    ...
    def test01_2500gold(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_gold2500, '\Automation\Reports\Total_Front\GOLD\Test01_bug.png')
        ...
        # Clicking to image of 100 dollars
        self.imagedollars = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_Gold\sgold100.png', 50,
                                         error_gold2500, '\Automation\Reports\Total_Front\GOLD\Test01_bug.png')
        ...
        run_time = end_time - start_time2500
