...
class VIP(unittest.TestCase):
    ...
    def test04_150gold(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_gold150, '\Automation\Reports\Total_Front\GOLD\Test04_bug.png')
        ...
        # Clicking to image of 10 dollars
        self.imagedollars = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_Gold\sgold10.png', 50,
                                         error_gold150, '\Automation\Reports\Total_Front\GOLD\Test04_bug.png')
        ...
        run_time = end_time - start_time150
