...
class VIP(unittest.TestCase):
    ...
    def test06_20gold(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_gold20, '\Automation\Reports\Total_Front\GOLD\Test06_bug.png')
        ...
        # Clicking to image of 2 dollars
        self.imagedollars = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_Gold\sgold2.png', 50,
                                         error_gold20, '\Automation\Reports\Total_Front\GOLD\Test06_bug.png')
        ...
        run_time = end_time - start_time20
