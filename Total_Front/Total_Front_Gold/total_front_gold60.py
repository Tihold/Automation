...
class VIP(unittest.TestCase):
    ...
    def test05_60gold(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\sigrat.png', 50,
                                  error_gold60, '\Automation\Reports\Total_Front\GOLD\Test05_bug.png')
        ...
        # Clicking to image of 5 dollars
        self.imagedollars = ImageClicker('C:\Automation\Screens\Total_Front\Total_Front_Gold\sgold5.png', 50,
                                         error_gold60, '\Automation\Reports\Total_Front\GOLD\Test05_bug.png')
        ...
        run_time = end_time - start_time60
