...
test06_start_time = datetime.now()
...
class GoldenCoin(unittest.TestCase):
    ...
    def test06_3000_golden_coins(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\Tplay.png', 50,
                                  er_coins_test06, '\Automation\Reports\Totem\Totem_Coins\Golden\Test06_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Totem\Coins\golden_plus.png', 50, er_coins_test06,
                                         '\Automation\Reports\Totem\Totem_Coins\Golden\Test06_bug.png', 1)
        ...
        self.sbuy = RegionsLocator('C:\Automation\Screens\Totem\Coins\sbuy.png', 50, er_coins_test06,
                                   '\Automation\Reports\Totem\Totem_Coins\Golden\Test06_bug.png', 5)
        ...
        run_time = end_time - test06_start_time
        run_time1 = str(run_time)
        run_time2 = (run_time1[:-7])
        tf = r'C:\Totem_coins_Log.txt'
        f2 = open(tf, 'a')
        if coins_delta_int == 3000:
            f2.write("***************************************************************" + '\n'
                     + 'TEST 6 completed in: ' + str(timenow2) + '\n'
