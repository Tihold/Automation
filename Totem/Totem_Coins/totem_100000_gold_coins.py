...
test02_start_time = datetime.now()
...
class GoldenCoin(unittest.TestCase):
    ...
    def test02_100000_golden_coins(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\Tplay.png', 50,
                                  er_coins_test02, '\Automation\Reports\Totem\Totem_Coins\Golden\Test02_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Totem\Coins\golden_plus.png', 50, er_coins_test02,
                                         '\Automation\Reports\Totem\Totem_Coins\Golden\Test02_bug.png', 1)
        ...
        self.sbuy = RegionsLocator('C:\Automation\Screens\Totem\Coins\sbuy.png', 50, er_coins_test02,
                                   '\Automation\Reports\Totem\Totem_Coins\Golden\Test02_bug.png', 1)
