...
test01_start_time = datetime.now()
...
class GoldenCoin(unittest.TestCase):
    ...
    def test01_200000_golden_coins(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\Tplay.png', 50,
                                  er_coins_test01, '\Automation\Reports\Totem\Totem_Coins\Golden\Test01_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Totem\Coins\golden_plus.png', 50, er_coins_test01,
                                         '\Automation\Reports\Totem\Totem_Coins\Golden\Test01_bug.png', 1)
        ...
        self.sbuy = RegionsLocator('C:\Automation\Screens\Totem\Coins\sbuy.png', 50, er_coins_test01,
                                   '\Automation\Reports\Totem\Totem_Coins\Golden\Test01_bug.png', 0)
