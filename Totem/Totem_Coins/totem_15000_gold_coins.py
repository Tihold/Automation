...
test04_start_time = datetime.now()
...
class GoldenCoin(unittest.TestCase):
    ...
    def test04_15000_golden_coins(self):
        ...
        self.splay = ImageClicker('C:\Automation\Screens\FB_Start\Tplay.png', 50,
                                  er_coins_test04, '\Automation\Reports\Totem\Totem_Coins\Golden\Test04_bug.png')
        ...
        self.plus_coins = RegionsLocator('C:\Automation\Screens\Totem\Coins\golden_plus.png', 50, er_coins_test04,
                                         '\Automation\Reports\Totem\Totem_Coins\Golden\Test04_bug.png', 1)
        ...
        self.sbuy = RegionsLocator('C:\Automation\Screens\Totem\Coins\sbuy.png', 50, er_coins_test04,
                                   '\Automation\Reports\Totem\Totem_Coins\Golden\Test04_bug.png', 3)
